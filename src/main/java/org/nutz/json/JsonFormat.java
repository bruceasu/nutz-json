...
public class JsonFormat implements Cloneable {
     ...
     * <li>分隔符为『"』
     *
     * @param compact true: 使用紧凑模式输出，false: 不使用紧凑模式输出
     */
     ...
     * 设置Json输出格式的给字段添加双引号
     *
     * @param quoteName true: 给字段添加双引号，false: 不给字段添加双引号
     * @return 该Json输出格式
     */
     ...
     * 设置Json输出格式中是否忽略null
     *
     * @param ignoreNull true: 忽略null的值，false: 不忽略null的值
     * @return 该Json输出格式
     */
     ...
     *
     * @param autoUnicode true: 自动将值应用unicode编码，false: 不自动将值应用unicode编码
     * @return 该Json输出格式
     */
     ...
     *
     * @param unicodeLower true: unicode编码用大写，false: unicode编码用小写
     * @return 该Json输出格式
     */
